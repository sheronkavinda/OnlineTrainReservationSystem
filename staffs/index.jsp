...
<head>
  ...
  <title>LankaRails | Staff Management</title>
  ...
  <div class="flex-1 flex flex-col md:ml-60">
    ...
    <main class="flex-1 p-6 space-y-6">
      ...
      <div class="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
        <a href="${pageContext.request.contextPath}/staff/manage?action=create"
              ...
              <c:when test="${not empty staffList}">
                <c:forEach var="staff" items="${staffList}">
                  <tr class="border-b border-slate-800 hover:bg-slate-800/50">
                    ...
                    <td class="px-6 py-4">${staff.createdAt}</td>
                    <td class="px-6 py-4 text-center space-x-3">
                      <a href="${pageContext.request.contextPath}/staff/manage?action=edit&id=${staff.staffId}" class="text-green-400 hover:text-green-500">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a href="${pageContext.request.contextPath}/staff/manage?action=delete&id=${staff.staffId}" onclick="return confirmDelete(this.href);" class="text-red-400 hover:text-red-500">
